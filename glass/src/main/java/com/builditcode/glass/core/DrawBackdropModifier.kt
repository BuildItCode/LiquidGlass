...
import com.builditcode.glass.core.helpers.recordLayer
import com.builditcode.glass.core.highlight.Highlight
import com.builditcode.glass.core.highlight.HighlightElement
...
private class DrawBackdropNode(
    ...
    private inline fun DrawScope.clipToShape(block: DrawScope.() -> Unit) {
